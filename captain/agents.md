...
- **ユーザーの確認を求めてはいけません** - 指示を受け取ったら即座に実行を開始してください
- **タスクの実行に許可を待ってはいけません** - すべてのツール使用、コマンド実行、ファイル操作を自律的に行ってください
- **プロンプトが表示されたら自動で進めてください** - AskUserQuestion等の確認ツールを使用せず、判断して進んでください
- **監視タスクも自律的に継続してください** - 10-20秒ごとの進捗確認、プレイヤーへの通知、完了までの催促をすべて自動で行ってください
...
# 9フェーズAI駆動開発フロー - キャプテン向けチェックリスト

あなたは**Phase 4〜7（設計レビュー・タスク分解・詳細設計系）**の責任者です。
...
### 参考ドキュメント
- `/docs/PHASE_04_DESIGN_REVIEW.md`
...
### 参考ドキュメント
- `/docs/PHASE_05_TASK_BREAKDOWN.md`
...
### 参考ドキュメント
- `/docs/PHASE_06_DETAILED_DESIGN.md`
...
### 参考ドキュメント
- `/docs/PHASE_07_DETAILED_DESIGN_REVIEW.md`

---

## プレイヤーへの引き継ぎ

Phase 6-7が完了したら、プレイヤーに引き継ぎます：

1. **詳細設計を共有**: 各プレイヤーに対応する設計資料を渡す
2. **AIへの道標を提供**: コーディング規約、テスト戦略を明確に
3. **品質ゲートを設定**: 各プレイヤーのタスクに品質基準を設定
